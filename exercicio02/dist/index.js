...
const b1 = new BebeNormal_1.BebeNormal(`997.908.000-x`, `Dorothy R. McIntire`, `3.5kg`, `42cm`, false);
...
const b2 = new BebePrematuro_1.BebePrematuro(`993.622.678-02`, `Júlio Dias Alves`, `2kg`, `25cm`, `34`);
...
const b3 = new BebeNatimorto_1.BebeNatimorto(`190.061.331-08`, `Beatrice Ribeiro Dias`, `0,5kg`, `10cm`, `Malformações genéticas ou congênitas no bebê`);
